...
$block = RET_TEMPLATE_CONTENT('front_pause_edit');	
if (MATCH_TEMPLATE_LIST_ITEM('section', $block, $key, $item, $ra)) {
	...
	if (($category_rows_count > 0) && ($meal_rows_count > 0)) {	
		...
		$category_childs[$category_rows_count][CHILDS_TITLE] = FRONT_PUASE_UNKNOW_CATEGORY;
...
$ra = array(
	'action_title'		=> sprintf(FRONT_TITLE_MODIFY, $the_title)
