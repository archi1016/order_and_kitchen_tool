...
$the_db_2 = RET_DB_FILE_2(PREFIX_FLAVOR, $the_row[COMMON_ID]);
...
switch ($the_operation_2) {
	case OPERATION_NEW:
		require('__back/flavor____member__new.php');
		break;
		
	case OPERATION_INSERT:
		require('__back/flavor____member__insert.php');
		break;
		
	case OPERATION_EDIT:
		require('__back/flavor____member__edit.php');
		break;
		
	case OPERATION_SAVE:
		require('__back/flavor____member__save.php');
		break;
		
	case OPERATION_REMOVE:
		require('__back/flavor____member__remove.php');
		break;
	...
	default:
		require('__back/flavor____member__list.php');
		break;
}
